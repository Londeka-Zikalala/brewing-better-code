...
const Strategy_2 = require("../src/Strategy");
const Strategy_3 = require("../src/Strategy");
describe('CoffeeMaker Tests', function () {
    ...
    it('should brew coffee using the Espresso Strategy', function () {
        const espressoStrategy = new Strategy_1.EspressoStrategy();
    ...
    it('should brew coffee using the French Press Strategy', function () {
        const frenchPressStrategy = new Strategy_2.FrenchPressStrategy();
    ...
    it('should brew coffee using the Pour Over Strategy', function () {
        const pourOverStrategy = new Strategy_3.PourOverStrategy();
